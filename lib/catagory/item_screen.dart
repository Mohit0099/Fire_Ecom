import 'package:ecom_firebase/catagory/item_controller.dart';
import 'package:ecom_firebase/itemdetail/item_details.dart';
import 'package:ecom_firebase/model/item_model.dart';
import 'package:ecom_firebase/search/search_screen.dart';
...
class ItemsScreen extends StatelessWidget {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return listViewBuilderItems(
                                size, controller.itemsData[index]);
                          },
                        );
                      } else
  ...
  Widget listViewBuilderItems(Size size, ItemModel model) {
    int discount =
